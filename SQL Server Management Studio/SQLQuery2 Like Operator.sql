...
% :- The percent sign (moduler) represents Zero,one,or multiple characters
...
insert into MyEmployee_1 values(111, 'Ashish', 'Male', 25000, 'Karanchi', 3)
insert into MyEmployee_1 values(112, 'Prity', 'Female', 25000, 'Ramgarh', 3)
insert into MyEmployee_1 values(113, 'Aashish', 'Male', 25000, 'Karanchi', 3)
insert into MyEmployee_1 values(114, 'Priti', 'Female', 25000, 'Ramgarh', 3)
...
select * from MyEmployee_1 where Emp_Name like '[as][nu]%' 

select * from MyEmployee_1 where Emp_Name like '[asa][num]%' 

select * from MyEmployee_1 where Emp_Name like '[aapp][sarr][hsii][ihtt][siyi]%' 

select * from MyEmployee_1 where Emp_Name like '[apa][sra][his]%' 

select * from MyEmployee_1 where Emp_Name like '[a-n]%' 

select * from MyEmployee_1 where Emp_Name like '[aa-g]%' 
